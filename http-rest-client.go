...
func updateEmployee(w http.ResponseWriter, r *http.Request) {
   ...
   if err != nil {
     log.Print("error occured while updating employee :: ", err)
     return
   }
   printOutput(response, err)
   fmt.Fprintf(w, response.String())
...
func deleteEmployee(w http.ResponseWriter, r *http.Request) {
  ...
  decodingErr:= json.NewDecoder(r.Body).Decode(&employee)
  if decodingErr != nil {
     log.Print("error occured while decoding data :: ", decodingErr)
     return
  }
  ...
  if err != nil {
    log.Print("error occured while deleting employee :: ", err)
    return
  }
  printOutput(response, err)
  fmt.Fprintf(w, response.String())
