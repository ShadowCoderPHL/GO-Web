...
func init() {
   employees = Employees {
        Employee{Id: "1", FirstName: "Aaron", LastName: "Dolim"},
   }
   employeesV1 = Employees {
        Employee{Id: "1", FirstName: "Kakarot", LastName: "Dolim"},
        Employee{Id: "2", FirstName: "Picolo", LastName: "Villanueva"},
   }
   employeesV2 = Employees {
        Employee{Id: "1", FirstName: "Raditz", LastName: "Dolim"},
        Employee{Id: "2", FirstName: "Gohan", LastName: "Villanueva"},
   }
}
