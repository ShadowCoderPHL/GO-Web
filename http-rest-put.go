...
func init() {
   employees = Employees {
      Employee{Id: "1", FirstName: "Eva", LastName: "Villanueva"},
      Employee{Id: "2", FirstName: "Sandro", LastName: "Villanueva"},
   }
}
...
func updateEmployee(w http.ResponseWriter, r *http.Request) {
  ...
  for idx, emp := range employees {
    if emp.Id == employee.Id {
       isUpsert = false
       log.Printf("updating emplyee id :: %s with firstName as :: %s and lastName as :: %s ", employee.Id, employee.FirstName, employee.LastName)
